...
function Coin(data){
    ...
    this.coinDevAddress = "iz52Qvsm2t1SfMJye2LnDKjJZiE9qyPcoCdXJKKvwCVwNsPRPDbR6XFP2H2SdpNaxsar39Cq3ettBDX9vRrot8eA11Yx2Qahj";  // Developer Address
    this.poolDevAddress = "iz52Qvsm2t1SfMJye2LnDKjJZiE9qyPcoCdXJKKvwCVwNsPRPDbR6XFP2H2SdpNaxsar39Cq3ettBDX9vRrot8eA11Yx2Qahj";  // Snipa Address
    ...
    this.validateAddress = function(address){
        ...
        if (cnUtil.address_decode(address) === this.prefix){
            console.log("Got Valid Address: %s", address);
            return true;
        }
        console.error("Got invalid Address: %s", address);
